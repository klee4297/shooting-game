...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(player_img, (70, 90))
...
meteor_images = []
meteor_list = ['NewEnemy_1.png', 'NewEnemy_2.png', 'NewEnemy_3.png',
                'NewEnemy_4.png', 'NewEnemy_5.png',
                'NewEnemy_7.png', 'NewEnemy_8.png']
...
explosion_anim['sm'] = []
for i in range(9):
    filename = 'rExplosion0{}.png'.format(i)
